class Computer:
    ...
    def execute(self, intcode, ip=0):
        ...
        """
        # the ip is provide if this program is being "resumed" after a pause;
        # otherwise it is a restart
...
def jump(ip, intcode, if_true, pm1=0, pm2=0, base=0):
    ...
    v2 = read_value(intcode, a2)
    ip += 3
    # if-true: if the first parameter is non-zero, it sets the instruction pointer to the value
    #          from the second parameter. Otherwise, it does nothing.
    # if-false: if the first parameter is zero, it sets the instruction pointer to the value from
