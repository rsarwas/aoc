...
def part2(data):
    ...
    min_vx = initial_vx(
        target
    )  # any velocity less than this will never get to the target
    max_vx = target[
        1
    ]  # x2 any velocity greater than this will miss the target on the first step
    min_vy = target[
        2
    ]  # y2 any velocity greater than this will miss the target on the first step
