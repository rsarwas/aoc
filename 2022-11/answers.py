...
TEST = [
    {"items": [79, 98], "op": tf0, "divisor": 23, "throw": (2, 3), "inspections": 0},
    {
        "items": [54, 65, 75, 74],
        "op": tf1,
        "divisor": 19,
    ...
    {"items": [74], "op": tf3, "divisor": 17, "throw": (0, 1), "inspections": 0},
]
...
DATA = [
    ...
    {"items": [52], "op": f2, "divisor": 2, "throw": (3, 1), "inspections": 0},
    {
    ...
    {"items": [79, 53], "op": f5, "divisor": 3, "throw": (0, 6), "inspections": 0},
    {
    ...
    {"items": [58, 83, 89], "op": f7, "divisor": 17, "throw": (2, 1), "inspections": 0},
]
